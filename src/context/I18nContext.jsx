...
const dict = {
  en: {
    ...
    home: {
      ...
      offersSubtitle: 'Exclusive deals on premium cuts',
      offer1Title: 'Weekend Special',
      offer1Desc: 'Get 15% off on all chicken products every weekend',
      offer2Title: 'Family Pack',
      offer2Desc: 'Buy 5 lbs or more of any cut and save 10%',
      offer3Title: 'Premium Selection',
      offer3Desc: 'Try our premium ribeye and lamb chops at special prices',
      certTitle: 'Quality & Certification',
      certSubtitle: 'Trusted standards you can count on',
      cert1: 'Kosher Certified',
      cert1Desc: 'All products meet strict kosher standards',
      cert2: 'Fresh Daily',
      cert2Desc: 'Delivered and prepared fresh every day',
      cert3: 'Expert Butchers',
      cert3Desc: 'Skilled craftsmen with generations of experience',
      cert4: 'Premium Quality',
      cert4Desc: 'Only the finest cuts from trusted suppliers'
    },
  ...
  fr: {
    ...
    home: {
      ...
      offersSubtitle: 'Promotions exclusives sur nos coupes premium',
      offer1Title: 'Spécial Week-end',
      offer1Desc: '15% de réduction sur tous les produits de poulet chaque week-end',
      offer2Title: 'Pack Familial',
      offer2Desc: 'Achetez 5 lb ou plus de n\'importe quelle coupe et économisez 10%',
      offer3Title: 'Sélection Premium',
      offer3Desc: 'Essayez notre ribeye premium et nos côtelettes d\'agneau à prix spécial',
      certTitle: 'Qualité & Certification',
      certSubtitle: 'Des standards de confiance sur lesquels vous pouvez compter',
      cert1: 'Certifié Casher',
      cert1Desc: 'Tous nos produits respectent les normes casher strictes',
      cert2: 'Frais Quotidiennement',
      cert2Desc: 'Livrés et préparés frais chaque jour',
      cert3: 'Bouchers Experts',
      cert3Desc: 'Artisans qualifiés avec des générations d\'expérience',
      cert4: 'Qualité Premium',
      cert4Desc: 'Seulement les meilleures coupes de fournisseurs de confiance'
    },
